...
class MageWorx_CustomOptions_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    const XML_PATH_CUSTOMOPTIONS_DISPLAY_LOW_STOCK_MESSAGE = 'mageworx_catalog/customoptions/display_low_stock_message';
    const XML_PATH_CUSTOMOPTIONS_LOW_STOCK_VALUE = 'mageworx_catalog/customoptions/low_stock_value';
    const XML_PATH_CUSTOMOPTIONS_ENABLE_EXTRAS = 'mageworx_catalog/customoptions/enable_extras';
    const XML_PATH_CUSTOMOPTIONS_MINIMUM_QTY_ALLOWE_IN_SHOPPING_CART = 'mageworx_catalog/customoptions/minimum_qty_allowed_in_shopping_cart';
    const XML_PATH_CUSTOMOPTIONS_MAXIMUM_QTY_ALLOWE_IN_SHOPPING_CART = 'mageworx_catalog/customoptions/maximum_qty_allowed_in_shopping_cart';
    ...
    public function getFormatedOptionPrice($product, $option, $value = null) {
        ...
        if ($this->isSkuPriceLinkingEnabled() && $model->getSku()!==NULL && $model->getSku()!='' && $model->getTaxClassId()>0) { // if sku = 0
    ...
    public function getCustomoptionsQty($customoptionsQty, $sku, $productId=0, $extra=null, $value=null, $quoteItemId=0, $quote=null, $returnWithBackorders=false) {
        $backorders = false;
    ...
    public function isProductQtyDecimal($product) {
        ...
        if (is_object($product)) {
            $isDecimal = $product->getData('stock_item')->getIsQtyDecimal();
        }
        return $isDecimal;
    }
    ...
    public function removeQtyZeroes($qty) {
        ...
        return ($qty != NULL && $qty > 0) ? rtrim(rtrim($qty, 0), ".") : 0;
    }
