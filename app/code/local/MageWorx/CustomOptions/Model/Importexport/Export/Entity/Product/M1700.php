...
class MageWorx_CustomOptions_Model_Importexport_Export_Entity_Product_M1700 extends Mage_ImportExport_Model_Export_Entity_Product
{
    ...
    public function export() {
        ...
        $customOptCols        = array(
            ...
            // APO additions block
            '_custom_option_template_id', '_custom_option_view_mode', '_custom_option_customoptions_is_onetime', 
            ...
            '_custom_option_row_dependent_ids', '_custom_option_row_weight', '_custom_option_row_cost',
        ...
        foreach ($this->_storeIdToCode as $storeId => &$storeCode) {
            ...
            foreach ($options as $option) {
                ...
                if ($defaultStoreId == $storeId) {
                    ...
                    // APO additions block
                    $row['_custom_option_template_id']   = $option->getTemplateId() ? $option->getTemplateId() : '';
                    ...
                    $row['_custom_option_store_views'] = $option['store_views'];
                    ...
                    // APO additions block
                    if ($option->getTemplateId() != $customOptions[0]['_custom_option_template_id']) {
                        $row['_custom_option_template_id'] = $option->getTemplateId() ? $option->getTemplateId() : '';
                    }
                ...
                if ($values) {
                    ...
                    foreach ($values as $value) {
                        ...
                        if ($defaultStoreId == $storeId) {
                            ...
                            $row['_custom_option_row_customoptions_min_qty']  = $value['customoptions_min_qty'];
                            $row['_custom_option_row_customoptions_max_qty']  = $value['customoptions_max_qty'];
