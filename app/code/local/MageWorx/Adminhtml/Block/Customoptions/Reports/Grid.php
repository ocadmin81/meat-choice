...
class MageWorx_Adminhtml_Block_Customoptions_Reports_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection() {
        $collection = Mage::getModel('customoptions/stock')->getCollection();
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('product_name', array(
            ...
            'index' => 'product_name',
            'renderer'  => 'MageWorx_Adminhtml_Block_Customoptions_Reports_Renderer_ProductName',
        ));
        ...
        $this->addColumn('qty', array(
                ...
                'type'  => 'number',
                'index' => 'qty',
                'renderer'  => 'MageWorx_Adminhtml_Block_Customoptions_Reports_Renderer_Qty',
        ));
        ...
        $this->addColumn('sku', array(
            ...
            'index' => 'sku',
            'width' => '80px',
            'renderer'  => 'MageWorx_Adminhtml_Block_Customoptions_Reports_Renderer_LinkedSku',
        ));
