                            ...
                            foreach ($option->getValues() as $key => $_value) {
                                ...
                                if ($_value->getIsDelete() != '1') {
                                    ...
                                    $value['optionValues'][$key] = array(
                                        ...
                                        'description' => $this->htmlEscape(isset($storeOptionsArr[$optionId]['values'][$_value->getOptionTypeId()]['description'])?$storeOptionsArr[$optionId]['values'][$_value->getOptionTypeId()]['description']:$_value->getDescription()),
