...
class AW_Layerednavigation_Block_Filter_Type_Option_Attribute extends AW_Layerednavigation_Block_Filter_Type_Option
{
    /**
    ...
    public function getOptionList()
    {
        ...
        foreach ($countList as $key => $value) {
            if ($value == 0 && !$this->isOptionChecked($items[$key]) ) {
                unset($countList[$key]);
            }
        }
