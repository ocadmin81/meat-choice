...
class Magentothem_Banner7_Block_Adminhtml_Banner7_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
	  ...
	  $this->addColumn('image_mobile', array(
          'header'    => Mage::helper('banner7')->__('Image Mobile'),
          'align'     =>'left',
          'index'     => 'image_mobile',
      ));
      ...
      $this->addColumn('status', array(
		...
		echo '<script type="text/javascript">$j(document).ready(function(){ $j("td.a-left").each(function(){var f1 = $j(this);var t2=f1.html();t2=t2.replace(/&lt;img/g, "<img");t2=t2.replace(/&gt;/g, ">");t2 = t2.replace("yoururl/","'.Mage::getBaseUrl('media').'"); f1.html(t2);})});</script>';
