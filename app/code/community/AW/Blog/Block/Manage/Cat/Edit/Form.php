...
class AW_Blog_Block_Manage_Cat_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
		...
		$fieldset->addField('icon', 'image', array(
			'label'     => Mage::helper('blog')->__('Category Icon'),
			'required'  => false,
			'name'      => 'icon',
		));
		$fieldset->addField('home', 'select', array(
        ...
        $fieldset->addField('home_posts', 'text', array(
            'label' => Mage::helper('blog')->__('Posts in home page'),
            'name' => 'home_posts',
        ));
