...
amconfAjax.prototype =
{
    ...
    {
        var selector =  '.category-products div.price-box [id^=product-price-qq], ' +
            '.category-products div.special-price [id^=product-price-qq], ' +
            '.category-products div.price-box [id^=price-excluding-tax-qq], ' +
            '.category-products div.price-box [id^=price-including-tax-qq], ' +
            '.category-products div.price-box [id^=parent-product-price-qq], ' +
            '.category-products div.price-box [id^=old-price-qq]';
